export default function Contact() {
    ...
    return (
        <section className="text-gray-600 body-font relative bg-white border-b-2">
        <div className="container px-5 py-16 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              If you&apos;re curious about our software or have any questions, feel free to contact us!
            </p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-red-800 border-0 py-2 px-8 focus:outline-none hover:bg-red-900 rounded text-lg">Button</button>
              </div>
            </div>
          </div>
        </div>
