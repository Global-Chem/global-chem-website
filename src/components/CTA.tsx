...
export default function CTA() {
  return (
    <section className="mx-auto text-white md:px-8 mb-10">
      <div className="grid flex-col-reverse items-center grid-cols-1 md:grid-cols-2 gap-y-2 md:gap-y-32 gap-x-10 md:gap-x-24 my-10">
